...
function setupServicesDropdown() {
    ...
    if (btnSend) {
        btnSend.addEventListener("click", () => {
            ...
            window.open("https://api.whatsapp.com/send?phone=584122665492&text=" + encodeURIComponent(preview.textContent), "_blank");
    ...
    if (btnAgendar) {
        btnAgendar.addEventListener("click", (e) => {
            ...
            window.open("https://api.whatsapp.com/send?phone=584122665492&text=" + encodeURIComponent(msg), "_blank");
            setTimeout(() => {
